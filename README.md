...
```bash
docker pull iru44/adonis-template
```
...
```bash
docker run -p 3000:3000 iru44/adonis-template
```
...
```bash
git clone https://github.com/CLIuno/CLIuno-Adonis-template.git
```
